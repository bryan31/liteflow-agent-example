...
class LocalJsonAgentApplicationTest {

    @Test
    void configUsesJsonStateAndAgentScope2GuardedLocalFilesystem() throws Exception {
        ...
        assertThat(properties.getProperty("spring.application.name"))
                .isEqualTo("liteflow-agent-web-local-json");
        ...
        assertThat(properties.getProperty("liteflow.agent.session-store.json-root"))
                .isEqualTo("./data/local-json/agent-state");
        assertThat(properties.getProperty("liteflow.agent.harness.local.workspace-root"))
                .isEqualTo("./data");
        assertThat(properties.getProperty("example.artifacts.root"))
                .isEqualTo("./data/local-json/artifacts");
    ...
    void applicationDoesNotPrintAgentStreamEventsDirectly() {
        boolean hasPrintEventMethod = Arrays.stream(LocalJsonAgentApplication.class.getDeclaredMethods())
                .map(Method::getName)
